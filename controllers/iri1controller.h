...
private:
    ...
    CEpuckProximitySensor* m_seProx;
        ...
        CRealRedLightSensor* m_seLight_Red;
        CRealBlueLightSensor* m_seLight_Blue;
        ...
        CBlueBatterySensor* m_seBattery_Blue;   
    ...
    double    fEvitarToSeguirInhibitor;
    ...
    /* Behaviors */
        ...
        void SeguirLuces        ( unsigned int un_priority );
        ...
        void EvitarLuces        ( unsigned int un_priority );
        void Ralentizar        ( unsigned int un_priority );
        void SinBateria        ( unsigned int un_priority );
